<template>
  <v-tabs color="deep-purple accent-4" right>
    ...
    <v-tab-item> <SnippetsSetupVisitType /> </v-tab-item>
    <v-tab-item> <SnippetsSetupServiceCallType /> </v-tab-item>
    <v-tab-item> <SnippetsSetupPriority /> </v-tab-item>
